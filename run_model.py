...
# postcodes = pd.DataFrame(['RG2 9UW', 'HP2 4JW', 'N7 6QD', 'SN2 8DA', 'TR7 2BB'])
# data_source_library = {
#     "uk_monthly_police_reporting": r"Risk - Documents\DATA 2\CY Crime\sector_level_crime.csv",  # done
#     "schools": r"Risk - Documents\DATA 2\Schools\schools_for_script.csv",  # done
#     "uk_retail_parks_&_shopping_centres": r"Risk - Documents\DATA 2\Retail & Shopping Parks\retail_shopping_park_locations.csv",  # done
#     "uk_major_junction": r"Risk - Documents\DATA 2\Junctions\Junctions.xlsx",  # done
#     "uk_transport_hubs": r"Risk - Documents\DATA 2\Transport Hubs\England_Scotland_Wales_transport_hubs.csv",  # done
#     "uk_wellbeing": r"Risk - Documents\DATA 2\Wellbeing\uk_wellbeing_for_script.csv",  # done
#     "uk_unemployment": r"Risk - Documents\DATA 2\Unemployment_Student\uk_unemployment_for_script.csv",  # done
#     "uk_historic_detailed_police_reporting": r"Risk - Documents\DATA 2\Historic Crime\uk_historic_crime_data_for_script.xlsx",  # done
#     "scottish_monthly_police_reporting": r"Risk - Documents\DATA 2\CY Crime\Police Scotland\Scotland_CY_Crime.csv",  # NOT DONE
#     "uk_population_density": r"Risk - Documents\DATA 2\Population Density\uk_population_density_for_script.csv",  # done
#     "scotland_population_density": r"Risk - Documents\DATA 2\Population Density\scotland_population_density_for_script.csv",  # done
#     "uk_student_population": r"Risk - Documents\DATA 2\Unemployment_Student\uk_student_population_for_script.csv",  # done
#     "scotland_student_population": r"Risk - Documents\DATA 2\Unemployment_Student\scotland_student_population_for_script.csv",  # done
#     "scotland_unemployment": r"Risk - Documents\DATA 2\Unemployment_Student\scotland_unemployment_for_script.csv",  # done
#     "scotland_historic_detailed_police_reporting": r"Risk - Documents\DATA 2\Historic Crime\scotland_historic_crime_data_for_script.csv",
#     "ni_monthly_police_reporting": r"Risk - Documents\DATA 2\CY Crime\ni_monthly_crime_for_script.csv",
#     "ni_population_density": r"Risk - Documents\DATA 2\Population Density\ni_population_density_for_script.csv",  # done
#     "ni_wellbeing": r"Risk - Documents\DATA 2\Wellbeing\ni_wellbeing_for_script.csv",  # done
#     "ni_student_population": r"Risk - Documents\DATA 2\Unemployment_Student\ni_student_population_for_script.csv",  # done
#     "ni_unemployment": r"Risk - Documents\DATA 2\Unemployment_Student\ni_unemployment_for_script.csv",  # done
#     "pubs": r"Risk - Documents\DATA 2\Pubs\pubs_for_script.csv",
#     "scottish_postcode_directory": r"Risk - Documents\DATA 2\Historic Crime\scottish_postcode_directory.csv"
# }
